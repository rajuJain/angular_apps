...
angular.module('AngularDemo')
    ...
    */
    .controller('twowaychartsController', ['$scope', 'serviceData','$location','serviceAuth', function ($scope, serviceData, $location, serviceAuth) {
        $scope.sliderValue = 0;
        ...
        $scope.rate = null;
        $scope.graphReq = null;
        $scope.years =  ['10', '20', '30'];
        
        //get data from api ..
        serviceData.get('getSlides', {module_id: 1}).then(function (response) {
            if (response.response_code == 200 && response.result == "success") {
               $scope.chart_content = response.data[0].CONTENT;
               $scope.chart_content = JSON.parse($scope.chart_content);
        ...
        $scope.nextSlide = function() {
          $('#textSlide').removeClass('graph1Desc');
          $('#textSlide').addClass('graph1Desc2');
        }
        ...
        $scope.changeValue = function() {
            ...
            angular.forEach($scope.years, function(yearVal, yearIndex){
               ...
               if (!$scope.chart_content) {
                  ...
                  expression = $scope.sliderValue * expression;
