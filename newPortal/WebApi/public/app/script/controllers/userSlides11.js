...
angular.module('AngularDemo')
    ...
    */
    .controller('userSlidesController', ['$scope', 'serviceData','$location','serviceAuth', function ($scope, serviceData, $location, serviceAuth) {
        $scope.allData = null;
        $scope.sliderValue = 0;
        ...
        $scope.nextSlide = function(index) {
          $('#slide1').removeClass("graphDesc");
          $('#slide1').addClass("graphDesc1");
